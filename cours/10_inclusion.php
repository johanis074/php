...
<body>
    ...
    include '10_01exemple.inc.php';  // le fichier dont le chemin est spécifié est inclus ici. En cas d'erreur lors de l'inclusion du fichier, include génère une erreur de type warning et continue l'exécution du script
    ...
    include_once '10_01exemple.inc.php';  // le once vérifie si le fichier a déjà été inclus. Si c'est le cas, il ne le ré-inclut pas.
    ...
    require '10_01exemple.inc.php';  // le fichier est "requis" donc obligatoire : en cas d'erreur lors de l'inclusion du fichier, require génère une erreur de type "fatal error" et stoppe l'exécution du script 
    ...
    require_once '10_01exemple.inc.php';   // le once vérifie si le fichier a déjà été inclus. Si c'est le cas, il ne le ré-inclut pas.
