...
// exemple de type d'un paramètre
...
{
    return join(array_reverse(str_split($str, 1)));
}
...
{
    $tab = [];
    // Boucle pour générer la table de multiplication de $number
    for ($i = 1; $i <= 10; $i++) {
        $result = $number * $i;
...
$multiple = generateMultiplicationTable(3);
